"""
Django settings for ZayrahLifeBackend project.
...
ROOT_URLCONF = 'ZayrahLifeBackend.urls'
...
WSGI_APPLICATION = 'ZayrahLifeBackend.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'ZayrahLifeBackend.core.pagination.Pagination',
    'PAGE_SIZE': 10,
