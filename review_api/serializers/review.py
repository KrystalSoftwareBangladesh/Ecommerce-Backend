...
#     # avatar = serializers.ImageField(read_only=True, source='profile.avatar')    # noqa
...
#     """
#     user = UserMinimalSerializer(source='created_by', read_only=True)
#     product_id = serializers.IntegerField(source='product.id', read_only=True)    # noqa
#     product_name = serializers.CharField(source='product.name', read_only=True)   # noqa
#     status_display = serializers.CharField(
#         source='get_status_display', read_only=True)
